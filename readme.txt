...
When using woocommerce blocks in cart or checkout page you can use Woo Donations Block to display donation form. Please <a href="https://youtu.be/t9JjLhYcu54" target="_blank">watch the video</a> for more details.
...
2. Label Options
3. Shortcode Page
4. Specifc Donation Product Edit Page
5. Simple Donation Product
6. Variable Donation Product
7. Cart Page  -- Donation Form
8. Checkout Page --  Donation Form
9. Order Confirm Page
10. Admin Orders
11. Gutenberg Block for Donation Form
12. Elementor Widget for Donation Form
...
= 4.3.8 =
 Fixed Woocommerce templates override.
...
= 4.3.2 =
 Added multiple donation form option
